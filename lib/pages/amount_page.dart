...
import 'package:Nagad/pages/pin_page.dart';
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              Padding(padding: EdgeInsets.all(12), child: Center(child: Row(children: [Expanded(child: Padding(padding: EdgeInsets.fromLTRB(12,8,0,12), child: Text("Available balance: ৳13,870.98", style: AppTheme.avlAmtText2, textAlign: TextAlign.center,),)),
              ],),),),
