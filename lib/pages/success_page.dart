            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 20,),
                  Row(children: const [Expanded(child: Text('Tanvir Mohammad Rizvy', style: TextStyle(color: Colors.black, fontWeight: FontWeight.normal, fontSize: 16), textAlign: TextAlign.center,))],),
                  SizedBox(height: 10,),
